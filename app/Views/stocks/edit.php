    ...
    <div class="bg-surface rounded-xl border border-gray-700 p-8">
        <form action="/stocks/<?= $stock['id'] ?>/edit" method="post">
            ...
            <div class="flex justify-end space-x-3 mt-6">
                <a href="/stocks/<?= $stock['id'] ?>" class="px-6 py-3 rounded-lg bg-page border border-gray-600 text-gray-300 hover:text-white transition text-sm">
                    Cancel
                </a>
                ...
                <button type="submit" class="px-6 py-3 rounded-lg bg-accent hover:bg-accent-2 text-on-accent font-semibold transition text-sm">
