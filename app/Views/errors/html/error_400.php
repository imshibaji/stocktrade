...
<head>
    ...
    <title>Bad Request | <?= esc($errorSiteName) ?></title>
    <script>
    (function () {
        try {
...
<body class="bg-page text-ink min-h-screen flex items-center justify-center">
    <div class="text-center px-4">
        ...
        <h1 class="text-6xl font-bold text-ink mb-4">400</h1>
        <h2 class="text-2xl text-ink-2 mb-6">Bad Request</h2>
        ...
        <div class="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a href="/" class="text-ink-4 hover:text-ink text-sm">
        ...
        <div class="mt-12 text-left max-w-2xl mx-auto p-4 bg-surface rounded-lg border border-edge overflow-hidden">
            ...
            <pre class="text-xs text-ink-3 overflow-x-auto"><?= esc($message) ?></pre>
        </div>
        <?php endif; ?>
    </div>
</body>
