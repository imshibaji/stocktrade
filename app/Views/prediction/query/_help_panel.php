    ...
    <details class="bg-page rounded-xl border border-gray-700 overflow-hidden">
        ...
        <div class="px-5 pb-5 space-y-3 text-xs">
            ...
            <?php $examples = [
                ...
                'monte_carlo'          => 'close > sma(20) AND volume_ratio(20) > 1',
                'sma_follow'           => 'close > sma(10) AND close < sma(30)',
                'wma_follow'           => 'close > ema(20) AND linreg_slope(20) > 0',
                'holt_linear'          => 'close > sma(50) AND rsi(14) > 50',
                'roc_follow'           => 'roc(20) > 0 AND close > sma(20)',
                'donchian_breakout'    => 'close > sma(50) AND volume_ratio(20) > 1.2',
                'fibonacci_projection' => 'close > sma(50) AND rsi(14) > 55',
                'stochastic_reversion' => 'stoch_k(14) < 20 AND close > sma(50)',
            ]; ?>
