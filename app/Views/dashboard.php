        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <div class="wl-card p-4 bg-page rounded-lg border border-transparent hover:border-accent transition cursor-pointer" onclick="location.href='/stocks/<?= $sid ?>'" data-wlid="<?= $ws['id'] ?>">
                <div class="flex justify-between items-start mb-2">
                    ...
                    <span class="text-xs px-2 py-0.5 rounded bg-surface border border-gray-600 text-gray-300 shrink-0 ml-2"><?= esc(exchange_display($ws['exchange'] ?? null, $ws['exchange_display'] ?? null)) ?></span>
                </div>
