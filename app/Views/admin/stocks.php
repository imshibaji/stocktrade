    ...
    <div class="flex">
        ...
        <div class="w-64 bg-navy2 border-r border-gray-700 min-h-screen">
            ...
            <nav class="p-2">
                ...
                <a href="/admin/stocks" class="flex items-center gap-2 px-4 py-3 text-gray-300 hover:text-white hover:bg-navy rounded-lg transition text-white bg-navy">Stocks</a>
                        ...
                        <?php foreach ($stocks as $stock): ?>
                            <tr class="border-b border-gray-700/50">
                                ...
                                <td class="px-4 py-3 text-right">
                                    <a href="/stocks/<?= $stock['id'] ?>" class="px-2 py-1 bg-navy border border-gray-600 text-gray-300 text-xs rounded hover:text-white">View</a>
