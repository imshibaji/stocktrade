        ...
        <div class="flex-1 p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                ...
                <div class="bg-surface rounded-xl p-6 border border-gray-700">
                    ...
                    <a href="/admin/screeners" class="text-accent text-sm hover:text-accent-2 mt-2 inline-block">Manage screeners</a>
                </div>
            </div>
            ...
            <div class="bg-surface rounded-xl border border-gray-700 p-6">
                ...
                <div class="flex flex-wrap gap-3">
                    <a href="/admin/users" class="bg-page border border-gray-600 text-gray-300 hover:text-white hover:border-accent px-4 py-2 rounded-lg text-sm transition">Manage Users</a>
                    <a href="/admin/stocks" class="bg-page border border-gray-600 text-gray-300 hover:text-white hover:border-accent px-4 py-2 rounded-lg text-sm transition">Manage Stocks</a>
                    <a href="/admin/pages/create" class="bg-page border border-gray-600 text-gray-300 hover:text-white hover:border-accent px-4 py-2 rounded-lg text-sm transition">Add New Page</a>
