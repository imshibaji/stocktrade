<section class="max-w-2xl mx-auto py-4">
    ...
    <div class="bg-surface rounded-xl border border-gray-700 p-8 mb-6">
        <h2 class="text-white font-bold text-lg mb-6 flex items-center">
            <i class="fas fa-user-edit text-accent mr-2"></i>Edit Profile
        </h2>
        ...
        <form action="/settings/update-profile" method="post">
            ...
            <button type="submit" class="bg-accent hover:bg-accent-2 text-on-accent font-semibold px-6 py-3 rounded-lg text-sm transition">
    ...
    <div class="bg-surface rounded-xl border border-gray-700 p-8 mb-6">
        <h2 class="text-white font-bold text-lg mb-6 flex items-center">
            <i class="fas fa-palette text-accent mr-2"></i>Appearance
        </h2>
    ...
    <div class="bg-surface rounded-xl border border-gray-700 p-8 mb-6">
        <h2 class="text-white font-bold text-lg mb-6 flex items-center">
            <i class="fas fa-calculator text-accent mr-2"></i>Tax Settings
        </h2>
    ...
    <div class="bg-surface rounded-xl border border-gray-700 p-8 mb-6">
        <h2 class="text-white font-bold text-lg mb-6 flex items-center">
            <i class="fas fa-receipt text-accent mr-2"></i>Brokerage &amp; Transaction Fees
        </h2>
        ...
        <form action="/settings/update-fees" method="post">
            ...
            <button type="submit" class="bg-accent hover:bg-accent-2 text-on-accent font-semibold px-6 py-3 rounded-lg text-sm transition mt-4">
    ...
    <div class="bg-surface rounded-xl border border-gray-700 p-8 mb-6">
        <h2 class="text-white font-bold text-lg mb-6 flex items-center">
            <i class="fas fa-globe text-accent mr-2"></i>Base Currency
        </h2>
        ...
        <form action="/settings/update-base-currency" method="post">
            ...
            <div class="mb-4">
                ...
                <select name="base_currency" class="w-full bg-page border border-gray-600 rounded-lg px-4 py-3 text-white focus:border-accent focus:outline-hidden">
    ...
    <div class="bg-surface rounded-xl border border-gray-700 p-8">
        <h2 class="text-white font-bold text-lg mb-6 flex items-center">
