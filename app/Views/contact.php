<section class="py-8">
    <div class="text-center mb-12">
        <h1 class="text-4xl font-bold text-white mb-4">Contact <span class="text-gold">Us</span></h1>
