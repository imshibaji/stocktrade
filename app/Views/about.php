<section class="py-8">
    <div class="text-center mb-12">
        <h1 class="text-4xl font-bold text-white mb-4">About <span class="text-gold">StockTrade Tips</span></h1>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-12 mb-16">
        <div>
            ...
            <p class="text-gray-400 leading-relaxed mb-4">
                At StockTrade Tips, we believe every investor deserves access to professional-grade analysis tools. Our platform combines real-time market data with advanced prediction algorithms to help you make informed investment decisions.
            </p>
        ...
        <div class="bg-navy2 rounded-xl p-8 border border-gray-700">
            <h3 class="text-gold font-semibold text-lg mb-4">Platform Highlights</h3>
            <ul class="space-y-3">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
        <div class="text-center bg-navy2 rounded-xl p-8 border border-gray-700">
