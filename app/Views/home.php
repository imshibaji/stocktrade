<section class="text-center py-16">
    <h1 class="text-5xl font-bold text-white mb-4">
        Smart Stock <span class="text-gold">Trading Tips</span>
    </h1>
    ...
    <div class="flex justify-center space-x-4">
        <?php if (!is_logged_in()): ?>
        <a href="/register" class="bg-gold hover:bg-gold2 text-navy font-bold px-8 py-3 rounded-lg text-lg transition">
            Get Started Free
        </a>
        <a href="/about" class="border border-gold text-gold hover:bg-gold/10 px-8 py-3 rounded-lg text-lg transition">
            Learn More
        </a>
        <?php else: ?>
        <a href="/dashboard" class="bg-gold hover:bg-gold2 text-navy font-bold px-8 py-3 rounded-lg text-lg transition">
            Go to Dashboard
        </a>
        <a href="/stocks" class="border border-gold text-gold hover:bg-gold/10 px-8 py-3 rounded-lg text-lg transition">
            Browse Stocks
        </a>
        <?php endif; ?>
    </div>
...
<section class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-16">
    <div class="bg-navy2 rounded-xl p-6 border border-gray-700 text-center hover:border-gold transition">
        <i class="fas fa-chart-bar text-4xl text-gold mb-3"></i>
    ...
    <div class="bg-navy2 rounded-xl p-6 border border-gray-700 text-center hover:border-gold transition">
        <i class="fas fa-chart-line text-4xl text-gold mb-3"></i>
    ...
    <div class="bg-navy2 rounded-xl p-6 border border-gray-700 text-center hover:border-gold transition">
        <i class="fas fa-calculator text-4xl text-gold mb-3"></i>
    ...
    <div class="bg-navy2 rounded-xl p-6 border border-gray-700 text-center hover:border-gold transition">
        <i class="fas fa-star text-4xl text-gold mb-3"></i>
...
<section class="text-center py-12 bg-navy2 rounded-2xl border border-gray-700">
    ...
    <?php if (!is_logged_in()): ?>
    <a href="/register" class="bg-gold hover:bg-gold2 text-navy font-bold px-10 py-3 rounded-lg text-lg transition">
        Create Free Account
    </a>
    <?php else: ?>
    <a href="/stocks" class="bg-gold hover:bg-gold2 text-navy font-bold px-10 py-3 rounded-lg text-lg transition">
        Explore Stocks
    </a>
    <?php endif; ?>
</section>
